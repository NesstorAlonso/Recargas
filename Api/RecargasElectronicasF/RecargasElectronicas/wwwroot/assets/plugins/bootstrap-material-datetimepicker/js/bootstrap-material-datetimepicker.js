(function ($, moment) {
    ...
    function Plugin(element, options) {
        ...
        this.params = { date: true, time: true, format: 'YYYY-MM-DD', minDate: null, maxDate: null, currentDate: null, lang: 'es', weekStart: 0, shortTime: false, clearButton: false, nowButton: false, cancelText: 'Cancel', okText: 'OK', clearText: 'Clear', nowText: 'Now', switchOnClick: false };
    ...
    Plugin.prototype =
        {
            ...
            initTemplate: function () {
                this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                    ...
                    '<button class="dtp-btn-ok btn btn-primary btn-round btn-flat hidden">' + this.params.okText + '</button>' +
                    '<div class="clearfix"></div>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
            ...
            _onSelectDate: function (e) {
                ...
                //seleccionar sin presionar el boton ok
                this.setElementValue();
                this.hide();
        ...
        _onSelectMinute: function (e) {
            ...
            //        this.showTime(this.currentDate);
            //        //para presionar sin seleccionar el ok
            //        this.setElementValue();
            //        this.hide();
            //        this.animateHands();
